# Archived VEDAXI Research and Product Handoff

> Historical planning context only. This document contains superseded directions and is not the current build or release guide. Start with the repository `README.md`.
