...
| --- | --- | --- |
| Video | `docs/assets/M2/final-demo.mp4` | MP4 container (`video/mp4`), H.264/AVC video and AAC audio; duration must be **strictly greater than 192 seconds**. |
| Captions | `docs/assets/M2/final-demo.vtt` | UTF-8 WebVTT. A cue covering `00:03:12.000` must contain both required phrases below. |
